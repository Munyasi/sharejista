...
export class UserAccountApi extends BaseLoopBackApi {
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UserAccounts/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.UserAccount#getCurrent
   * @methodOf sdk.UserAccount
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/UserAccounts" + "/:id";
   ...
   * call to {@link sdk.UserAccount#login} or
   * {@link sdk.UserAccount#getCurrent}. Return null when there
   ...
   * call to {@link sdk.UserAccount#login}
   *
  ...
  /**
   * @name sdk.UserAccount#isAuthenticated
   *
  ...
  /**
   * @name sdk.UserAccount#getCurrentId
   *
