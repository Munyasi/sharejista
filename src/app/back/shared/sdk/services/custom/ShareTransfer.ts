 ...
 */
@Injectable()
export class ShareTransferApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getTransferer(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public getTransferee(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   *  - `data` – `{Object}` - 
   */
  public approveTransfer(sharetransfer_id: any, action: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   *  - `data` – `{Object}` - 
   */
  public approveAllotment(sharetransfer_id: any, action: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/sharetransfers/approveallotment";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof sharetransfer_id !== 'undefined' && sharetransfer_id !== null) _urlParams.sharetransfer_id = sharetransfer_id;
   ...
   *  - `data` – `{Object}` - 
   */
  public listAllotments(company_id: any, skip: any = {}, limit: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/sharetransfers/list-allotments";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   *  - `data` – `{Object}` - 
   */
  public listTransfers(company_id: any, skip: any = {}, limit: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   *  - `data` – `{Object}` - 
   */
  public search(q: any, company_id: any, transferer_type: any, limit: any = {}, skip: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/sharetransfers/search";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   *  - `data` – `{Object}` - 
   */
  public generateShareCertificate(transferId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/sharetransfers/generate-share-certificate";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof transferId !== 'undefined' && transferId !== null) _urlParams.transferId = transferId;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
