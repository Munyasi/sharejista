...
var OfficerComponent = (function () {
    function OfficerComponent(personApi, toastr, route, storageBrowser) {
    ...
    OfficerComponent.prototype.showTab = function (index) {
        this.tab_num = "tab" + index;
    };
    OfficerComponent.prototype.ngOnInit = function () {
        this.getShareholder();
    };
    OfficerComponent.prototype.getShareholder = function () {
        var _this = this;
        this.route.params.subscribe(function (params) {
            var id = +params['id'];
            console.log(id);
            _this.personApi.findById(id)
                .subscribe(function (person) {
                console.log(person);
                _this.person = person;
            }, function (error) {
                _this.toastr.error('Something went wrong while fetching officer. Please reload to retry.');
            });
        });
    };
    OfficerComponent = __decorate([
        core_1.Component({
            ...
            providers: [index_2.PersonApi, index_3.StorageBrowser]
        }), 
        __metadata('design:paramtypes', [index_2.PersonApi, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, index_3.StorageBrowser])
    ], OfficerComponent);
